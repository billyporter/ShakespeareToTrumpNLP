...
class Vocab(collections.abc.MutableSet):
    ...
    def __init__(self):
        ...
        self.word_to_num = {
            word: num
            for num, word in enumerate(self.num_to_word)
        }
...
def main(args):
    ...
    if args.train:
        ...
        if args.save:
            print('error: --save can only be used with --train',
                  file=sys.stderr)
            sys.exit()
        if args.dev:
            print('error: --dev can only be used with --train',
                  file=sys.stderr)
            sys.exit()
